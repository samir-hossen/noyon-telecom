...
// Previously hotlinked a photo from Unsplash's CDN as a "placeholder" —
// an unreliable external dependency on every pageview (same mistake fixed
// in HeroCarousel.jsx and importDisplayPrices.js). Empty img/images lets
// the frontend's own built-in placeholder icon (utils/fallbackImage.js)
// render instead — no network dependency, always shows something.
