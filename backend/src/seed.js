...
// img/images are intentionally empty — the frontend's built-in placeholder
// icon (utils/fallbackImage.js) covers this with zero external dependency;
// swap for real product photography via the admin panel once available.
// (Previously hotlinked Unsplash photos here, same mistake already fixed
// in HeroCarousel.jsx and the two import scripts — an external CDN call on
// every pageview with no guaranteed uptime isn't worth it even for sample
// dev data.)
const PRODUCTS = [
  {
