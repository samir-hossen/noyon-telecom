  ...
  return (
    <div className="category-grid">
      ...
      <Link to="/shop" className="category-tile category-tile-viewall">
        ...
        <span className="category-tile-name">View All Categories</span>
      </Link>
    </div>
  );
}
