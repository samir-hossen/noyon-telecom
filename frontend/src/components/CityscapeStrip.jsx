...
function Tree({ x, base, big }) {
  ...
  return (
    <g>
      ...
      <circle cx={x} cy={base - r * 1.5 - r * 0.6} r={r} className="cityscape-foliage" />
    </g>
  );
}
...
export default function CityscapeStrip() {
  ...
  return (
    <div className="cityscape-strip" aria-hidden="true">
      ...
      {/* Flat single-tone silhouette, matching the scene's simplified
          illustration style rather than a shaded/detailed rendering. */}
